...
private:
    ...
    hwlib::window_part ammo_value = hwlib::window_part( display, hwlib::location (devider, 0), hwlib::location (display_size_x - 48, font_height) );
    hwlib::window_ostream ammo_value_ostream = hwlib::window_ostream(ammo_value, font);

    hwlib::window_part health_value = hwlib::window_part( display, hwlib::location (devider, font_height), hwlib::location (display_size_x -40, font_height * 2) );
    ...
    hwlib::window_part player_value = hwlib::window_part( display, hwlib::location (devider, font_height * 3), hwlib::location (display_size_x -48, font_height * 4) );
    hwlib::window_ostream player_value_ostream = hwlib::window_ostream(player_value, font);
    
    hwlib::window_part deaths_value = hwlib::window_part( display, hwlib::location (devider, font_height * 4), hwlib::location (display_size_x -48, font_height * 5) );
    hwlib::window_ostream deaths_value_ostream = hwlib::window_ostream(deaths_value, font);
    
    hwlib::window_part countdown_value = hwlib::window_part( display, hwlib::location (devider, font_height * 5), hwlib::location (display_size_x -56, font_height * 6) );
	hwlib::window_ostream countdown_value_ostream = hwlib::window_ostream(countdown_value, font);
    
    hwlib::window_part command_value = hwlib::window_part( display, hwlib::location (devider, font_height * 6), hwlib::location (display_size_x -56, font_height * 7) );
